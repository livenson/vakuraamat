...
test:
	...
	@for t in parse_test geotiff_test search_test links_test health_test boot_test site_test userpack_test devchannel_test traffic_test streaming_test interior_test; do \
