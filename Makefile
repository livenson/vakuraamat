...
test:
	...
	@printf "%-18s " pipeline_test; python3 tools/pipeline_test.py | grep -E "PASSED|FAILED" | head -1
	@for t in parse_test geotiff_test search_test links_test health_test countries_test boot_test site_test userpack_test devchannel_test traffic_test streaming_test interior_test; do \
