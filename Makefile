...
test:
	...
	@for t in boot_test site_test userpack_test friends_test devchannel_test traffic_test streaming_test playthrough_test story_test farming_test hunting_test economy_test; do \
