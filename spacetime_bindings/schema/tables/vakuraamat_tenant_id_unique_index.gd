...
class_name VakuraamatTenantIdUniqueIndex extends _ModuleTableUniqueIndex

var _cache: Dictionary[int, VakuraamatTenant] = {}
...
func find(col_val: int) -> VakuraamatTenant:
