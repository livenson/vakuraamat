...
class_name VakuraamatImprovementIdUniqueIndex extends _ModuleTableUniqueIndex

var _cache: Dictionary[int, VakuraamatImprovement] = {}
...
func find(col_val: int) -> VakuraamatImprovement:
