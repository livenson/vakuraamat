...
class_name VakuraamatBidTunnusBTreeIndex extends _ModuleTableBTreeIndex
...
func filter(col_val: String) -> Array[VakuraamatBid]:
	var typed_array: Array[VakuraamatBid] = []
	typed_array.assign(_cache.get(col_val, []))
	return typed_array

func filter_range(from_val: String, to_val: String) -> Array[VakuraamatBid]:
	var typed_array: Array[VakuraamatBid] = []
	typed_array.assign(_range_rows(from_val, to_val))
	return typed_array

func filter_gte(col_val: String) -> Array[VakuraamatBid]:
	var typed_array: Array[VakuraamatBid] = []
	typed_array.assign(_gte_rows(col_val))
	return typed_array

func filter_gt(col_val: String) -> Array[VakuraamatBid]:
	var typed_array: Array[VakuraamatBid] = []
	typed_array.assign(_gt_rows(col_val))
	return typed_array

func filter_lte(col_val: String) -> Array[VakuraamatBid]:
	var typed_array: Array[VakuraamatBid] = []
	typed_array.assign(_lte_rows(col_val))
	return typed_array

func filter_lt(col_val: String) -> Array[VakuraamatBid]:
	var typed_array: Array[VakuraamatBid] = []
