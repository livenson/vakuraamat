...
@tool
class_name VakuraamatTickSchedule extends _ModuleTableType
...
static func create(p_scheduled_id: int, p_scheduled_at: ScheduleAt) -> VakuraamatTickSchedule:
	var result: VakuraamatTickSchedule = VakuraamatTickSchedule.new()
